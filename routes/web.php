...
use App\Http\Controllers\noticeController;
use App\Http\Controllers\addenroll;
...
//add enroll
Route::post('/addenrolld',[addenroll::class,'store']);


Route::get('/addenrollv', function () {
    return view('addenroll');
});
...
Route::get('/reports',[PaymentReportConroller::class,'getAllReport']);
...
Route::get('/addnoticev', function () {
    return view('addnotice');
});



Route::post('/addnotice',[noticeController::class,'store']);



Route::get('/noticeview', function () {
    $data=App\Models\notic::all();
    return view('noticeview')->with('noticeview',$data);
});
...
Route::get('/updatenotice/{id}',[noticeController::class,'updatenotice']);

Route::post('/updatednotice',[noticeController::class,'updatednotice']);




Route::get('/snoticeview', function () {
    $data=App\Models\notic::all();
    return view('snoticeview')->with('noticeview',$data);
});




Route::get('/adminnotice', function () {
    return view('adminnotice');
});
